function Remove-WslItem {
    ...
    process {
        ...
        Microsoft.PowerShell.Management\Remove-Item -Path ($Path | ForEach-Object {"\\wsl.localhost\$Distribution$_"}) @OtherParameters -ErrorAction Stop
    }
}